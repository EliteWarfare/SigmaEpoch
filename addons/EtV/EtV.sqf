...
EtV_ChargeCheck =
{
	...
	_nearVehs = nearestObjects [_unit,["Air","Ship","LandVehicle","CinderWallGarage_EPOCH","WoodLargeWallDoorL_EPOCH","WoodLargeWallDoor_EPOCH","CinderWall_EPOCH"],5];
...
EtV_TouchOff =
{
	...
	_explosives = _unit getVariable ["charges",[]];
	{
		...
		{
			_nearVehicle = (nearestObjects [_x,["Air","Ship","LandVehicle","CinderWallGarage_EPOCH","WoodLargeWallDoorL_EPOCH","WoodLargeWallDoor_EPOCH","CinderWall_EPOCH"],5]) select 0;
...
EtV_AttachCharge =
{
	...
	_nearVehicle = (nearestObjects [_unit,["Air","Ship","LandVehicle","CinderWallGarage_EPOCH","WoodLargeWallDoorL_EPOCH","WoodLargeWallDoor_EPOCH","CinderWall_EPOCH"],5]) select 0;
	...
	{		
		...
		if ((typeOf _nearVehicle) in ["CinderWallGarage_EPOCH","WoodLargeWallDoorL_EPOCH","WoodLargeWallDoor_EPOCH","CinderWall_EPOCH"]) then
		{
