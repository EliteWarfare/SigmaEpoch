...
_level1UIDs = ["76561198123788043"]; //Alan
//UID's for lvl 2 gear
_level2UIDs = ["76561198074208389","76561198066575039","76561198110957956","76561197976011764",
"76561198149832857","76561198021745490"]; //Elite,Mud,SHDW,Bad,Booby,Derpy
...
//this is the array of primary weapons the player can choose from, this has to be "weapon" type items
		[
			...
			"l85a2_epoch","l85a2_pink_epoch","l85a2_ugl_epoch","srifle_EBR_F","m4a3_EPOCH"
		],
...
//this is the array for "tool" items the player can choose from, this has to be "item" type items
		[
			"FAK","FAK","Heal_EPOCH","Defib_EPOCH","Repair_EPOCH","MeleeSledge","Plunger","MeleeSword"
		],
...
//only male Uniforms here
			...
			"U_C_Driver_1_red","U_O_FullGhillie_Ish"
		],
		[
...
//this is the array of Backpacks the player can choose from
		...
		"smallbackpack_red_epoch","smallbackpack_green_epoch","smallbackpack_teal_epoch","smallbackpack_pink_epoch","B_Parachute","B_Kitbag_rgr","B_Kitbag_mcamo","B_Kitbag_sgg","B_Kitbag_cbr",
...
_lvl1items = [
	...
	"ItemSodaMocha","EpochRadio8","honey_epoch","B_Kitbag_rgr","B_Kitbag_mcamo","B_Kitbag_sgg","B_Kitbag_cbr"
];

//if you want an item locked for lvl 2 donor, add it to this array
_lvl2items = [
	"NVG_EPOCH","l85a2_pink_epoch","m16Red_EPOCH","srifle_EBR_F","m4a3_EPOCH","MeleeSword","U_O_FullGhillie_Ish","B_Carryall_ocamo","B_Carryall_oucamo","B_Carryall_mcamo",
	"B_Carryall_khk","B_Carryall_cbr"
];
