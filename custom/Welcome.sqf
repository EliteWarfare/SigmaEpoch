...
_shorttext         = "Arma 3 Epoch By EliteWarfare";
_posText        = [0.8,0.5,0.4];


_title2         = "Website";
_shorttext2     = "http://sigmaepoch.enjin.com/";
_posText2        = [0.8,0.5,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "voice.sigmarpg.tk";
...
_shorttext5     = "Welcome Messages <br />AI Missions<br />AI Roaming<br />IgiLoad<br /> and many more! ";
